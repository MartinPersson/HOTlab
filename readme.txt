...
Uncomment all lines in GenerateHologramCUDA.cu marked ”SLMstuff”
Add LoadHologram.cpp to project. 
Put stdafx.h, PCIEboard.lib and PCIeboard.h in the project folder
