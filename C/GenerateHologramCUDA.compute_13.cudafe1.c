...
#line 335 "d:/Dropbox/CUDA/GenerateHologramCUDA/C/source/GenerateHologramCUDA.cu"
 int __cuda_local_var_517026_6_non_const_Ncoeff[5];
...
__cuda_local_var_517026_6_non_const_Ncoeff[0] = 20; __cuda_local_var_517026_6_non_const_Ncoeff[1] = 35; __cuda_local_var_517026_6_non_const_Ncoeff[2] = 56; __cuda_local_var_517026_6_non_const_Ncoeff[3] = 84; __cuda_local_var_517026_6_non_const_Ncoeff[4] = 120;

if ((3 <= PolOrder) && (PolOrder <= 7)) {
N_PolLUTCoeff = ((__cuda_local_var_517026_6_non_const_Ncoeff)[(PolOrder - 3)]); }

else  {
_Z13AfxMessageBoxPKcjj(((const char *)"Polynomial order out of range\n -coerced to 3"), 0U, 0U);
N_PolLUTCoeff = ((__cuda_local_var_517026_6_non_const_Ncoeff)[0]);
}
...
#line 396 "d:/Dropbox/CUDA/GenerateHologramCUDA/C/source/GenerateHologramCUDA.cu"
 int __cuda_local_var_517087_6_non_const_deviceCount;
#line 405 "d:/Dropbox/CUDA/GenerateHologramCUDA/C/source/GenerateHologramCUDA.cu"
 struct cudaDeviceProp __cuda_local_var_517096_17_non_const_deviceProp;





 int __cuda_local_var_517102_6_non_const_MaxIterations;


 float __cuda_local_var_517105_8_non_const_data_w_f;

 int __cuda_local_var_517107_6_non_const_half_w;

 float __cuda_local_var_517109_8_non_const_half_w_f;



 float __cuda_local_var_517113_8_non_const_N_pixels_f;

 int __cuda_local_var_517115_6_non_const_logN;


 float __cuda_local_var_517118_8_non_const_SLMpitch_f;
#line 449 "d:/Dropbox/CUDA/GenerateHologramCUDA/C/source/GenerateHologramCUDA.cu"
 int __cuda_local_var_517140_6_non_const_data_w_pow2;
#line 470 "d:/Dropbox/CUDA/GenerateHologramCUDA/C/source/GenerateHologramCUDA.cu"
 float *__cuda_local_var_517161_9_non_const_h_aLaserFFT;
...
__cuda_local_var_517087_6_non_const_deviceCount = 0;
if (((int)(cudaGetDeviceCount((&__cuda_local_var_517087_6_non_const_deviceCount)))) != 0) {
_Z13AfxMessageBoxPKcjj(((const char *)"No CUDA compatible GPU found"), 0U, 0U); }
if (deviceId >= __cuda_local_var_517087_6_non_const_deviceCount)
{
...
{ cudaGetDeviceProperties((&__cuda_local_var_517096_17_non_const_deviceProp), deviceId); { } }
maxThreads_device = (__cuda_local_var_517096_17_non_const_deviceProp.maxThreadsPerBlock);

borderWidthDC_i = 64;

__cuda_local_var_517102_6_non_const_MaxIterations = 1000;
data_w = 512;
...
__cuda_local_var_517105_8_non_const_data_w_f = ((float)data_w);
_Z18cudaMemcpyToSymbolIA1_fE9cudaErrorRKT_PKvjj14cudaMemcpyKind((((const float ( *)[1])&c_data_w_f)), ((const void *)(&__cuda_local_var_517105_8_non_const_data_w_f)), 4U, 0U, cudaMemcpyHostToDevice);
__cuda_local_var_517107_6_non_const_half_w = ((int)(data_w / 2));
_Z18cudaMemcpyToSymbolIA1_iE9cudaErrorRKT_PKvjj14cudaMemcpyKind((((const int ( *)[1])&c_half_w)), ((const void *)(&__cuda_local_var_517107_6_non_const_half_w)), 4U, 0U, cudaMemcpyHostToDevice);
__cuda_local_var_517109_8_non_const_half_w_f = (((float)data_w) / (2.0F));
_Z18cudaMemcpyToSymbolIA1_fE9cudaErrorRKT_PKvjj14cudaMemcpyKind((((const float ( *)[1])&c_half_w_f)), ((const void *)(&__cuda_local_var_517109_8_non_const_half_w_f)), 4U, 0U, cudaMemcpyHostToDevice);
...
__cuda_local_var_517113_8_non_const_N_pixels_f = ((float)N_pixels);
_Z18cudaMemcpyToSymbolIA1_fE9cudaErrorRKT_PKvjj14cudaMemcpyKind((((const float ( *)[1])&c_N_pixels_f)), ((const void *)(&__cuda_local_var_517113_8_non_const_N_pixels_f)), 4U, 0U, cudaMemcpyHostToDevice);
__cuda_local_var_517115_6_non_const_logN = ((int)((__T224 = __cuda_local_var_517105_8_non_const_data_w_f) , (log2f(__T224))));
_Z18cudaMemcpyToSymbolIA1_iE9cudaErrorRKT_PKvjj14cudaMemcpyKind((((const int ( *)[1])&c_log2data_w)), ((const void *)(&__cuda_local_var_517115_6_non_const_logN)), 4U, 0U, cudaMemcpyHostToDevice);
_Z18cudaMemcpyToSymbolIA1_bE9cudaErrorRKT_PKvjj14cudaMemcpyKind((((const char ( *)[1])&c_useRPC_b)), ((const void *)(&useRPC_b)), 1U, 0U, cudaMemcpyHostToDevice);
__cuda_local_var_517118_8_non_const_SLMpitch_f = ((1.0F) / __cuda_local_var_517105_8_non_const_data_w_f);
_Z18cudaMemcpyToSymbolIA1_fE9cudaErrorRKT_PKvjj14cudaMemcpyKind((((const float ( *)[1])&c_SLMpitch_f)), ((const void *)(&__cuda_local_var_517118_8_non_const_SLMpitch_f)), 4U, 0U, cudaMemcpyHostToDevice);
...
{ cudaMalloc(((void **)(&d_weights)), (((unsigned)(256 * (__cuda_local_var_517102_6_non_const_MaxIterations + 1))) * 4U)); { } }
{ cudaMalloc(((void **)(&d_amps)), (((unsigned)(256 * __cuda_local_var_517102_6_non_const_MaxIterations)) * 4U)); { } }

{ cudaMalloc(((void **)(&d_obtainedPhase)), ((size_t)memsize_spotsf)); { } }
{ cudaMalloc(((void **)(&d_spotIm_f)), ((size_t)memsize_spotsf)); { } }

__cuda_local_var_517140_6_non_const_data_w_pow2 = ((int)((__T227 = ((__T226 = (((__T225 = ((float)data_w)) , (logf(__T225))) / (logf((2.0F))))) , (ceilf(__T226)))) , (powf((2.0F), __T227))));
{ cudaMalloc(((void **)(&d_pSLM_f)), (((unsigned)(__cuda_local_var_517140_6_non_const_data_w_pow2 * __cuda_local_var_517140_6_non_const_data_w_pow2)) * 4U)); { } }
{ cudaMemset(((void *)d_pSLM_f), 0, (((unsigned)(__cuda_local_var_517140_6_non_const_data_w_pow2 * __cuda_local_var_517140_6_non_const_data_w_pow2)) * 4U)); { } }
...
__cuda_local_var_517161_9_non_const_h_aLaserFFT = ((float *)(malloc(((size_t)memsize_SLM_f))));


EnableSLM_b = ((char)(EnableSLM != 0));
if (EnableSLM_b)
{
 char __cuda_local_var_517167_8_non_const_bRAMWriteEnable;
 unsigned char *__cuda_local_var_517168_18_non_const_h_LUT0_uc;
#line 476 "d:/Dropbox/CUDA/GenerateHologramCUDA/C/source/GenerateHologramCUDA.cu"
__cuda_local_var_517167_8_non_const_bRAMWriteEnable = ((char)0);
__cuda_local_var_517168_18_non_const_h_LUT0_uc = ((unsigned char *)(_Znaj(256U)));
ApplyLUT_b = ((char)((InitalizeSLM(__cuda_local_var_517167_8_non_const_bRAMWriteEnable, LUTFile, __cuda_local_var_517168_18_non_const_h_LUT0_uc, TrueFrames)) != 0));
{ cudaMalloc(((void **)(&d_LUT_uc)), 256U); { } }
{ cudaMemcpy(((void *)d_LUT_uc), ((const void *)__cuda_local_var_517168_18_non_const_h_LUT0_uc), 256U, cudaMemcpyHostToDevice); { } }
_ZdaPv(((void *)__cuda_local_var_517168_18_non_const_h_LUT0_uc));
SetPower(((char)1));
}
...
j = 0; for (; (j < N_spots); j++)
{
 float __cuda_local_var_517285_9_non_const_sincx_rec;
 float __cuda_local_var_517286_9_non_const_sincy_rec;
#line 594 "d:/Dropbox/CUDA/GenerateHologramCUDA/C/source/GenerateHologramCUDA.cu"
__cuda_local_var_517285_9_non_const_sincx_rec = (((x[j]) == (0.0F)) ? (1.0F) : ((((3.141592741F) * (x[j])) / SLMsizef) / (sinf((((3.141592741F) * (x[j])) / SLMsizef)))));
__cuda_local_var_517286_9_non_const_sincy_rec = (((y[j]) == (0.0F)) ? (1.0F) : ((((3.141592741F) * (y[j])) / SLMsizef) / (sinf((((3.141592741F) * (y[j])) / SLMsizef)))));
((h_desiredAmp)[j]) = (((h_I[j]) <= (0.0F)) ? (1.0F) : ((((__cuda_local_var_517285_9_non_const_sincx_rec * __cuda_local_var_517286_9_non_const_sincy_rec) * (sqrtf(((h_I[j]) / (100.0F))))) * SLMsizef) * SLMsizef));
if (method == 2) {
